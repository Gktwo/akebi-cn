...
namespace cheat::feature 
{
	PacketSniffer::PacketSniffer() : Feature(),
		NF(f_CaptureEnabled, u8"捕获", u8"包嗅探器", false),
		NF(f_ManipulationEnabled, u8"操纵", u8"包嗅探器", false),
		NF(f_PipeName, u8"通道名称", u8"包嗅探器", "genshin_packet_pipe")
	...
	{
		static const FeatureGUIInfo info{ u8"包嗅探器", u8"设置", true };
		return info;
	}
