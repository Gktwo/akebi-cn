...
namespace cheat::feature
{
    ...
    PaimonFollow::PaimonFollow() : Feature(),
        NFEX(f_Enabled, u8"ÅÉÃÎ¸úËæ", u8"ÅÉÃÎ¸úËæ", u8"Ä£×éºÍÊÓ¾õÀà", false, false)
    {
    ...
    {
        static const FeatureGUIInfo info{ u8"ÅÉÃÎ¸úËæ", u8"Ä£×éºÍÊÓ¾õÀà", true };
        return info;
    }

    void PaimonFollow::DrawMain()
    {
        ConfigWidget(u8"ÅÉÃÎ¸úËæ", f_Enabled, "To display paimon, turn on the function, open the profile (esc) and close it. \n" \
